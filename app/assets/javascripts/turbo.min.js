...
function p(e, t) {
  return m(e, t) && !!u(e).match(/^(?:|\.(?:htm|html|xhtml))$/);
}
function g(e) {
  const t = l(e);
...
function v(e, { target: t, cancelable: s, detail: i } = {}) {
...
(T.contentType = "text/vnd.turbo-stream.html"),
  (function (e) {
...
class k {
  ...
  async start() {
    ...
    if (this.needsConfirmation) {
      if (!k.confirmMethod(this.confirmationMessage, this.formElement)) return;
    }
  ...
  prepareHeadersForRequest(e, t) {
    if (!t.isIdempotent) {
      ...
      t && (e["X-CSRF-Token"] = t),
        (e.Accept = [T.contentType, e.Accept].join(", "));
    }
  }
  requestStarted(e) {
    var t;
  ...
  constructor(e, t) {
    (this.submitBubbled = (e) => {
      ...
      if (
        ...
        "dialog" !=
          ((null == s ? void 0 : s.getAttribute("formmethod")) || t.method) &&
...
class W {
    ...
    return y`
      .turbo-progress-bar {
        ...
        transition:
          ...
          opacity ${W.animationDuration / 2}ms ${
      W.animationDuration / 2
    }ms ease-in;
  ...
  fadeProgressElement(e) {
    (this.progressElement.style.opacity = "0"),
      setTimeout(e, 1.5 * W.animationDuration);
  }
  ...
  createStylesheetElement() {
    ...
    return (e.type = "text/css"), (e.textContent = W.defaultCSS), e;
  }
  ...
  constructor() {
    super(...arguments),
      (this.detailsByOuterHTML = this.children
        ...
        .reduce((e, t) => {
          const { outerHTML: s } = t,
            i = s in e ? e[s] : { type: N(t), tracked: x(t), elements: [] };
...
class U extends F {
  ...
  static fromDocument({ head: e, body: t }) {
    return new this(t, new V(e));
  }
  clone() {
    return new U(this.element.cloneNode(!0), this.headSnapshot);
  }
  get headElement() {
...
class z {
  constructor(e, t, s, i = {}) {
    (this.identifier = E()),
      ...
      (this.delegate = e),
      (this.location = t),
      (this.restorationIdentifier = s || E());
    const {
      action: r,
      historyChanged: n,
      referrer: o,
  ...
  issueRequest() {
    this.hasPreloadedResponse()
      ...
      : this.shouldIssueRequest() &&
        !this.request &&
        ((this.request = new A(this, i.get, this.location)),
        ...
        this.cacheSnapshot(),
          ...
          G(e) && null != t
            ? (await this.view.renderPage(
              ...
              this.complete())
            : (await this.view.renderError(U.fromHTMLString(t)),
              this.adapter.visitRendered(this),
              this.fail());
      });
    }
  ...
  getCachedSnapshot() {
    ...
    if (
      e &&
      (!l(this.location) || e.hasAnchor(l(this.location))) &&
      ("restore" == this.action || e.isPreviewable)
    )
      return e;
  }
  getPreloadedSnapshot() {
    if (this.snapshotHTML) return U.fromHTMLString(this.snapshotHTML);
  }
  hasCachedSnapshot() {
  ...
  requestErrored(e, t) {
    this.recordResponse({ statusCode: j.networkFailure, redirected: !1 });
  }
  requestFinished() {
    this.finishRequest();
  }
  ...
  cacheSnapshot() {
    this.snapshotCached ||
      (this.view.cacheSnapshot().then((e) => e && this.visitCachedSnapshot(e)),
...
class J {
  ...
  visitProposedToLocation(e, t) {
    this.navigator.startVisit(e, E(), t);
  }
  visitStarted(e) {
...
class X {
  constructor(e) {
    (this.element = e),
      ...
      (this.formInterceptor = new I(this, e));
  }
  start() {
...
class Z {
  ...
  start() {
    this.started ||
      (addEventListener("click", this.clickCaptured, !0), (this.started = !0));
  }
  stop() {
    this.started &&
...
class te {
  ...
  async formSubmissionSucceededWithResponse(e, t) {
    if (e == this.formSubmission) {
      const s = await t.responseHTML;
      if (s) {
        e.method != i.get && this.view.clearSnapshotCache();
  ...
  locationWithActionIsSamePage(e, t) {
    const s = l(e),
      i = l(this.view.lastRenderedLocation),
  ...
  getActionForFormSubmission(e) {
    const { formElement: t, submitter: s } = e,
      i = R("data-turbo-action", s, t);
    return ee(i) ? i : "advance";
  }
}
!(function (e) {
...
class se {
  ...
  start() {
    this.started ||
      (this.stage == _.initial && (this.stage = _.loading),
  ...
  pageIsInteractive() {
    this.stage == _.loading &&
      ((this.stage = _.interactive), this.delegate.pageBecameInteractive());
  }
  pageIsComplete() {
    this.pageIsInteractive(),
      this.stage == _.interactive &&
        ((this.stage = _.complete), this.delegate.pageLoaded());
  }
  get readyState() {
...
class re {
  ...
  receiveMessageHTML(e) {
    this.delegate.receivedMessageFromStream(new T(e));
  }
}
class ne extends O {
  async render() {
...
class ce extends H {
  constructor() {
    super(...arguments),
      (this.snapshotCache = new ae(10)),
      (this.lastRenderedLocation = new URL(location.href));
  }
  renderPage(e, t = !1, s = !0) {
    const i = new oe(this.snapshot, e, t, s);
  ...
  get snapshot() {
    return U.fromElement(this.element);
  }
...
const le = {
  ...
  de = new (class {
    constructor() {
      (this.navigator = new te(this)),
        (this.history = new Y(this)),
        (this.view = new ce(this, document.documentElement)),
        (this.adapter = new J(this)),
        (this.pageObserver = new se(this)),
        (this.cacheObserver = new K()),
        (this.linkClickObserver = new Z(this)),
        (this.formSubmitObserver = new Q(this)),
        (this.scrollObserver = new ie(this)),
        (this.streamObserver = new re(this)),
        (this.frameRedirector = new X(document.documentElement)),
        (this.drive = !0),
        (this.enabled = !0),
    ...
    renderStreamMessage(e) {
      document.documentElement.appendChild(T.wrap(e).fragment);
    }
    clearCache() {
      this.view.clearSnapshotCache();
    }
    ...
    convertLinkWithMethodClickToFormSubmission(e) {
      ...
      if (t) {
        ...
        return (
          ...
          v("submit", { cancelable: !0, target: s })
        );
      }
      return !1;
    }
    ...
    visitProposedToLocation(e, t) {
      he(e), this.adapter.visitProposedToLocation(e, t);
    }
    visitStarted(e) {
      he(e.location),
        e.silent ||
    ...
    notifyApplicationAfterVisitingLocation(e, t) {
      return (
        ...
        v("turbo:visit", { detail: { url: e.href, action: t } })
      );
    }
    ...
    notifyApplicationAfterPageLoad(e = {}) {
      return (
        ...
        v("turbo:load", { detail: { url: this.location.href, timing: e } })
      );
    }
    ...
    notifyApplicationAfterFrameLoad(e) {
      return v("turbo:frame-load", { target: e });
    }
...
function pe(e) {
  de.registerAdapter(e);
}
function ge(e, t) {
  de.visit(e, t);
}
function fe(e) {
  de.connectStreamSource(e);
}
function be(e) {
  de.disconnectStreamSource(e);
}
function ve(e) {
  de.renderStreamMessage(e);
}
function Se() {
  de.clearCache();
}
function we(e) {
  de.setProgressBarDelay(e);
}
function ye(e) {
  k.confirmMethod = e;
}
var Ee = Object.freeze({
  ...
  registerAdapter: pe,
  visit: ge,
  connectStreamSource: fe,
  disconnectStreamSource: be,
  renderStreamMessage: ve,
  clearCache: Se,
...
(c.delegateConstructor = class {
  constructor(e) {
    (this.fetchResponseLoaded = (e) => {}),
      ...
      (this.element = e),
      (this.view = new q(this, this.element)),
      (this.appearanceObserver = new P(this, this.element)),
      (this.linkInterceptor = new B(this, this.element)),
      (this.formInterceptor = new I(this, this.element));
  }
  connect() {
    this.connected ||
      ((this.connected = !0),
  ...
  async loadResponse(e) {
    ...
    try {
      ...
      if (t) {
        const { body: s } = w(t),
          i = new F(await this.extractForeignFrameElement(s)),
          r = new D(this.view.snapshot, i, !1, !1);
        this.view.renderPromise && (await this.view.renderPromise),
          await this.view.render(r),
          de.frameRendered(e, this.element),
  ...
  shouldInterceptLinkClick(e, t) {
    return (
      !e.hasAttribute("data-turbo-method") && this.shouldInterceptNavigation(e)
    );
  }
  linkClickIntercepted(e, t) {
  ...
  async visit(e) {
    var t;
    const s = new A(this, i.get, e, new URLSearchParams(), this.element);
    return (
  ...
  proposeVisitIfNavigatedWithAction(e, t, s) {
    const i = R("data-turbo-action", s, t, e);
    if (ee(i)) {
      const { visitCachedSnapshot: t } = new Re(e);
  ...
  async extractForeignFrameElement(e) {
    ...
    try {
      if ((t = Ce(e.querySelector(`turbo-frame#${s}`), this.currentURL)))
        return t;
      if (
        (t = Ce(
  ...
  shouldInterceptNavigation(e, t) {
    ...
    return !!de.elementDriveEnabled(e) && !(t && !de.elementDriveEnabled(t));
  }
  get id() {
  ...
  customElements.define("turbo-stream", Pe),
  (() => {
...
async function He(e, t) {
  const { subscriptions: s } = await Me();
  return s.create(e, t);
}
...
class Be extends HTMLElement {
  async connectedCallback() {
    fe(this),
      (this.subscription = await He(this.channel, {
        received: this.dispatchMessageEvent.bind(this),
      }));
  }
  disconnectedCallback() {
    be(this), this.subscription && this.subscription.unsubscribe();
  }
...
customElements.define("turbo-cable-stream-source", Be);
var Oe = { logger: self.console, WebSocket: self.WebSocket },
  De = {
    log(...e) {
      this.enabled &&
        (e.push(Date.now()), Oe.logger.log("[ActionCable]", ...e));
    },
  };
...
class Ne {
  ...
  stop() {
    this.isRunning() &&
      ...
      De.log("ConnectionMonitor stopped"));
  }
  isRunning() {
  ...
  recordConnect() {
    (this.reconnectAttempts = 0),
      ...
      De.log("ConnectionMonitor recorded connect");
  }
  recordDisconnect() {
    (this.disconnectedAt = We()),
      De.log("ConnectionMonitor recorded disconnect");
  }
  startPolling() {
  ...
  reconnectIfStale() {
    this.connectionIsStale() &&
      (De.log(
        ...
        }, time stale = ${Ve(this.refreshedAt)} s, stale threshold = ${
      ...
      this.disconnectedRecently()
        ? De.log(
            `ConnectionMonitor skipping reopening recent disconnect. time disconnected = ${Ve(
              this.disconnectedAt
            )} s`
          )
        : (De.log("ConnectionMonitor reopening"), this.connection.reopen()));
  }
  get refreshedAt() {
    return this.pingedAt ? this.pingedAt : this.startedAt;
  }
  connectionIsStale() {
    return Ve(this.refreshedAt) > this.constructor.staleThreshold;
  }
  disconnectedRecently() {
    return (
      this.disconnectedAt &&
      Ve(this.disconnectedAt) < this.constructor.staleThreshold
    );
  }
  visibilityDidChange() {
...
(Ne.staleThreshold = 6), (Ne.reconnectionBackoffRate = 0.15);
var xe = {
  message_types: {
    welcome: "welcome",
...
const { message_types: Ue, protocols: $e } = xe,
  je = $e.slice(0, $e.length - 1),
  _e = [].indexOf;
class ze {
  constructor(e) {
  ...
  open() {
    return this.isActive()
      ...
      : (De.log(
        ...
        (this.webSocket = new Oe.WebSocket(this.consumer.url, $e)),
  ...
  reopen() {
    if (
      (De.log(`Reopening WebSocket, current state is ${this.getState()}`),
      !this.isActive())
    )
      return this.open();
    try {
      ...
      De.log("Failed to reopen WebSocket", e);
    } finally {
      De.log(`Reopening WebSocket in ${this.constructor.reopenDelay}ms`),
  ...
  isProtocolSupported() {
    return _e.call(je, this.getProtocol()) >= 0;
  }
  isState(...e) {
    return _e.call(e, this.getState()) >= 0;
  }
  getState() {
    if (this.webSocket)
      for (let e in Oe.WebSocket)
        if (Oe.WebSocket[e] === this.webSocket.readyState)
  ...
  (ze.prototype.events = {
    message(e) {
      ...
      switch (n) {
        ...
        case Ue.disconnect:
          return (
            De.log(`Disconnecting. Reason: ${i}`),
            this.close({ allowReconnect: r })
          );
        case Ue.ping:
          return this.monitor.recordPing();
        case Ue.confirmation:
          return (
    ...
    close(e) {
      if ((De.log("WebSocket onclose event"), !this.disconnected))
        return (
          (this.disconnected = !0),
    ...
    error() {
      De.log("WebSocket onerror event");
    },
  });
class Ge {
  constructor(e, t = {}, s) {
...
class Je {
  ...
  guarantee(e) {
    -1 == this.pendingSubscriptions.indexOf(e)
      ? (De.log(`SubscriptionGuarantor guaranteeing ${e.identifier}`),
        this.pendingSubscriptions.push(e))
      : De.log(`SubscriptionGuarantor already guaranteeing ${e.identifier}`),
      this.startGuaranteeing();
  }
  forget(e) {
    De.log(`SubscriptionGuarantor forgetting ${e.identifier}`),
    ...
    this.retryTimeout = setTimeout(() => {
      this.subscriptions &&
        ...
        this.pendingSubscriptions.map((e) => {
          De.log(`SubscriptionGuarantor resubscribing ${e.identifier}`),
...
class Ke {
  constructor(e) {
    (this.consumer = e),
      (this.guarantor = new Je(this)),
      (this.subscriptions = []);
  }
  create(e, t) {
    const s = "object" == typeof e ? e : { channel: e },
      i = new Ge(this.consumer, s, t);
    return this.add(i);
  }
  add(e) {
    return (
  ...
  confirmSubscription(e) {
    De.log(`Subscription confirmed ${e}`),
...
class Qe {
  constructor(e) {
    (this._url = e),
      (this.subscriptions = new Ke(this)),
      (this.connection = new ze(this));
  }
  get url() {
    return Xe(this._url);
  }
...
var Ze = Object.freeze({
  __proto__: null,
  Connection: ze,
  ConnectionMonitor: Ne,
  Consumer: Qe,
  INTERNAL: xe,
  Subscription: Ge,
  Subscriptions: Ke,
  SubscriptionGuarantor: Je,
  adapters: Oe,
  createWebSocketURL: Xe,
  logger: De,
  createConsumer: function (e = Ye("url") || xe.default_mount_path) {
    return new Qe(e);
  },
  getConfig: Ye,
});
export { Te as Turbo, qe as cable };
